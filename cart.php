...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="sub-total"> sub total : <span><?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?></span><span> dhs</span> </div>
   ...
   <div class="cart-total">
      <p>grand total : <span><?= $grand_total; ?></span><span> dhs</span></p>
